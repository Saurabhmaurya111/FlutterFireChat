...
class AuthRepository extends BaseRepository {
  ...
  Future<UserModel> signUp({
    ...
    try {
     ...
     final phonenumberExists = await checkPhoneExits(formattedPhoneNumber);
      ...
      // crate user model and save it to db firebase
  ...
  Future<bool> checkPhoneExits(String phoneNumber)async{
    try {
       final formattedPhoneNumber = phoneNumber.replaceAll(RegExp(r'\s+'), "".trim());
